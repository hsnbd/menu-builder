            ...
            <div class="modal-content">
                ...
                <form action="" id="m_form" method="POST"
                    ...
                    <div class="modal-body">
                        <label for="m_title">{{ __('Title (En)') }}</label>
                        <input type="text" class="form-control" id="m_title" name="title"
                               placeholder="{{ __('Title (En)') }}"><br>
                        <label for="m_title">{{ __('Title (Bn)') }}</label>
                        <input type="text" class="form-control" id="m_title_bn" name="title_bn"
                               placeholder="{{ __('Title (Bn)') }}"><br>
        ...
        $(document).ready(function () {
            ...
            $m_modal.on('show.bs.modal', function (e, data) {
                ...
                if (_adding) {
                    ...
                    $m_title_bn.val(_src.data('title_bn'));
